...
Coordinates in pixels. Palette: cobalt #4268d8, amber #b88317, teal #258579, ink #23314d, muted #64748b, pale blue #edf2ff, pale yellow #fff6db. Use pale regions for grouping and high-contrast ink for labels. White background drawn by host. Text drawn by canvas, never HTML. metrics array contains 1-4 {label,value} strings; summary is one accurate sentence describing current parameter results.
...
const routes=new Set(['lessons','repair','revise','review','vision','tutor','plan','import-brief']);
...
export async function handleLearningRequest(request,env={},fetcher=fetch){
 ...
 try{
  ...
  phase='validate';
  if(!validOutput(route,result,op.schema)){
